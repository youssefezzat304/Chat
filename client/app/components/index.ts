...
// // --------------- alerts -----------------//
// export { default as TextBoxAlert } from "./alerts/FriendRequest.alert";
// // --------------- buttons -----------------//
// export { default as DarkModeBtn } from "./buttons/DarkModeBtn";
// export { default as SideBarButtons } from "./buttons/SideBarButtons";
// export { default as SideButton } from "./buttons/SideButton";
// export { default as UploadFileBtn } from "./buttons/UploadFileBtn";
// // --------------- dialogs -----------------//
...
// export { default as main } from "./scenes/main";
// // --------------- windows -----------------//
